...
local spawn_nodes = {
  "default:stone" -- Nós de pedra como base para spawn
}
...
local mob_textures = {
  "happy_mob_texture.png", -- Textura principal obrigatória
...
mobs:register_mob("happy_mob:happy", {
    ...
    mesh = "happy_mob.obj",   -- Arquivo do modelo 3D
...
mobs:spawn({
    ...
    active_object_count = 2,   -- Quantidade máxima na área
    min_height = -100,         -- Altura mínima no mapa
    max_height = 150           -- Altura máxima no mapa
})
